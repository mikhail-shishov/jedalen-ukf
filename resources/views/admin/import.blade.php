...
<style>
.import-section { max-width: 900px; }
.import-drop-zone {
...
.import-drop-zone.drag-over { background: #e9f5ff; border-color: #0d6efd; }
.import-drop-zone input[type=file] { display: none; }
.preview-table thead th { white-space: nowrap; }
.badge-date  { background: #e9ecef; color: #333; font-weight: 500; }
.step-badge  { width: 28px; height: 28px; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; font-weight: 700; flex-shrink: 0; }
.progress-list { max-height: 260px; overflow-y: auto; font-size: .85rem; }
.progress-list .item-ok   { color: #198754; }
.progress-list .item-err  { color: #dc3545; }
.progress-list .item-spin { color: #6c757d; }
</style>
...
<div class="card border-0 shadow-sm mb-3">
    <div class="card-body">
        ...
        <p class="text-muted small mb-3">
            ...
            Príklady: <code>2026-03-17,Svíčková na smotane,4.20</code> alebo <code>2026-03-17;Svíčková na smotane;4,20</code><br>
        ...
        <div class="import-drop-zone" id="dropZone">
            ...
            <div id="dropLabel">Presuňte CSV sem, alebo <a href="#" onclick="document.getElementById('csvFile').click();return false;">vyberte súbor</a></div>
    ...
    <div class="card-body">
        ...
        <div id="enrichProgress" class="d-none">
            ...
            <div class="progress mb-2" style="height:8px">
                <div id="enrichBar" class="progress-bar progress-bar-striped progress-bar-animated" style="width:0%"></div>
            </div>
